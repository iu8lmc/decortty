...
TRANSLATIONS = {
    ...
    "Drag to move the radio; the wheel tunes by 1 kHz —\n100 Hz with Shift, 10 kHz with Ctrl.":
        "Sleep om de radio te verplaatsen; het wiel stemt af per 1 kHz —\n100 Hz met Shift, 10 kHz met Ctrl.",
    ...
    "Binds to the station already on the radio when there\nis one, and takes the GUI role when the radio is free.":
        "Bindt zich aan het station dat er al is, en neemt de\nGUI-rol wanneer de radio vrij is.",
    "GUI STATION":
        "GUI-STATION",
    "Owns its own slices, so frequency and tuning always\nwork — at the cost of one of the two MultiFlex seats.":
        "Heeft eigen slices, dus frequentie en afstemming werken\naltijd — ten koste van een van de twee MultiFlex-plaatsen.",
    "SECOND CLIENT":
        "TWEEDE CLIENT",
    "Reads the slices of the station that already has the\nradio, without taking a seat. If the radio shows none,\nDecoRTTY goes back to being a GUI station by itself.":
        "Leest de slices van het station dat de radio al heeft,\nzonder een plaats te bezetten. Toont de radio er geen, dan\nwordt DecoRTTY vanzelf weer een GUI-station.",
    "Takes effect at the next connection.":
        "Werkt vanaf de volgende verbinding.",
    "Bound to %1 but the radio shows no slice — reconnecting as a GUI station":
        "Gebonden aan %1 maar de radio toont geen slice — opnieuw verbinden als GUI-station",
}
